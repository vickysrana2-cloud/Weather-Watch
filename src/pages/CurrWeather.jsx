...
const CurrWeather = () => {
  ...
  return (
    <>
      ...
      <div className="w-full rounded-2xl bg-sky-200 p-2 sm:pt-7 sm:p-10 mx-auto">
        <p className="text-center text-sm sm:text-xl font-semibold sm:pb-3 sm:px-5 text-indigo-600 ">Pick your location on the map to get real-time weather information below.</p>
